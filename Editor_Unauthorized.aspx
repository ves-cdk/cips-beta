<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editor_Unauthorized.aspx.cs" Inherits="cips_beta.Editor_Unauthorized" %>
	...
	<body class="claro">
		...
		<div id="header-container" class="navbar navbar-fixed-top">
			...
			<ul class="collapse navbar-collapse nav navbar-nav navbar-right" id="headerTabs">
				...
				<li id="openModeler">
					<a id="open-modeler" class="action" href="modeler.aspx"><i class="fa fa-cogs fa-lg" title="Launch CIPS Modeler"></i></a>
				</li>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
                        <br /><br />
                        <ul><li>
						This user account does not have CIPS editor permission.
                        </li></ul>
					</div>
				</div>
			</div>
