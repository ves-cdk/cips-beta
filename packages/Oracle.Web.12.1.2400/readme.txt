Oracle.Web Nuget Package Version 12.1.2400 README
=================================================

Release 12.1.0.2.400 for ODAC 12c Release 4
...
New Features 
============
This is the first release of this product for NuGet.
...
1. Un-GAC and un-configure any existing Oracle ASP.NET provider 12.1.0.2 versions you have installed. 
